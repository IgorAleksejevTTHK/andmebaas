...
', Laenutaja=', i.LaenutajaNimi, ', Kuupäev=', i.LaenutuseKuupäev)
FROM inserted i;
...
AS
BEGIN
SELECT r.RaamatID, r.Pealkiri, r.LehekülgedeArv
FROM Raamat r
...
insert into raamat(Pealkiri,LehekülgedeArv,AutorID)
values(1955, 222, 2)
...
INSERT INTO Raamat (Pealkiri,LehekülgedeArv) VALUES ('Põlev lipp', 290);
...
--vaade ühendab kolm tabelit ja kuvab kiiresti, kes millist raamatut laenas ja kes on selle autor
--see on kasulik näiteks raamatukogutöötajale, kes tahab näha kõik lihtsalt ja kiiresti
CREATE VIEW Vaade_Laenutused AS
SELECT l.LaenetusID, l.LaenutuseKuupäev,
